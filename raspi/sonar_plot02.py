#!/usr/bin/env python3
"""
sonar_plot02.py - sonar_radar02 スキャン結果を可視化する

sonar_radar02.py の出力（"angle"=モーター角度, "dome_angle"=dome角度,
...
使い方:
  python3 sonar_plot02.py scan.json
  python3 sonar_radar02.py > scan.json && python3 sonar_plot02.py scan.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="sonar_radar02 結果を可視化")
    ...
    parser.add_argument("--title", default="sonar_radar02 scan")
